...
urlpatterns = [
    ...
    url(r'^admin/news-dash/', views.NewsDash),
    ...
    url(r'^admin/activate-news/(?P<news_id>[\w-]+)/(?P<minutes>[\w-]+)/$', views.ActivateNews),
    url(r'^admin/deactivate-news/(?P<news_id>[\w-]+)/$', views.DeactivateNews),
